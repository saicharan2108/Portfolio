      ...
      <div className="home-container">
        <div className="home-content">
          {scrolled ? (
            ...
            <img
              className="img"
              src="https://pca-backend-media-static.s3.ap-south-1.amazonaws.com/frontend/webflow/ta-user-public-profile/square_badge.jpg"
              alt="img"
            />
          )}
          <Header />
        ...
        <div className="content">
          <div className="home-responsive">
            ...
            >
              ...
              <div className="name-info">
                <RiArrowRightCircleFill className="info" />{" "}
                <span className="info"> A Consistency Learner </span>
              </div>
            </motion.div>
            <motion.div
          ...
          <div className="about-me-section">
            ...
            <div className="about-me-flex">
              ...
              >
                <div className="about-info-container">
                  <h1 className="about-info-text">
                    <b className="color-cyan">
                      {" "}
                      <u>Hello There !</u>
                      <br />{" "}
                    </b>
            ...
            <div className="skills-section">
              ...
              <div className="skills-icons-container">
                ...
                <AnimationOnScroll animateIn="animate__flipInY">
                  <div className="skill-card">
                    <img
                      src="https://www.pngfind.com/pngs/m/487-4871694_p-python-logo-hd-png-download.png"
                      alt="skill-img"
                      className="skill-img sm"
                    />
              ...
              <p className="info-more"> loading more...</p>
            </div>
            <div className="contact-form">
              ...
              <AnimationOnScroll animateIn="animate__flipInX">
                <form className="form-container" onSubmit={this.formSubmitted}>
                  ...
                  {success && (
                    <p className="success">
                      Message Sent ✅, Thank for your valuable Feedback{" "}
                    </p>
                  )}
            ...
            <h3 className="end-info">
              {" "}
              Thanks for visiting our website & Make sure to travel around all
              sections.{" "}
            </h3>
          </div>
        </div>
